 ...
 */
#define SBI_SET_TIMER(stime_value) SBI_ECALL(SBI_TIMER_EID, SBI_SET_TIMER_FID, stime_value, 0, 0, 0, 0)
...
#define SBI_RFENCE_SFENCE_VMA(hart_mask, hart_mask_base, start_addr, size)                                             \
	SBI_ECALL(SBI_RFENCE_EID, SBI_RFENCE_SFENCE_VMA_FID, hart_mask, hart_mask_base, start_addr, size, 0)

#define SBI_RFENCE_SFENCE_VMA_ASID(hart_mask, hart_mask_base, start_addr, size, asid)                                  \
	SBI_ECALL(SBI_RFENCE_EID, SBI_RFENCE_SFENCE_VMA_FID, hart_mask, hart_mask_base, start_addr, size, asid)
...
#define SBI_HART_GET_STATUS(hartid) SBI_ECALL(SBI_HSM_EID, SBI_HART_GET_STATUS_FID, hartid, 0, 0, 0, 0)
